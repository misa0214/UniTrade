...
function showItemDetails(id) {
    ...
    const thumbs = (item.images || []).slice(1).map(im => 
        `<img src="${im.data}" class="me-2 mt-2" style="width:70px;height:70px;border-radius:8px;object-fit:cover;border:1px solid rgba(255,255,255,.08)">`
    ).join('');
